...
现在找内容经常不是只搜一个地方：生活经验在小红书，短视频在抖音和哔哩哔哩，观点在知乎，商品在淘宝，通用信息再回到百度。每次都要打开不同网站、重新输入关键词、来回切换入口，尤其在手机上更明显。

“仅搜索”想解决的就是这个小痛点：保留一个干净的搜索入口，把常用平台放在同一页。它不做内容抓取，不做账号系统，也不接入推荐流；只负责把关键词安全地带到你选择的平台。
